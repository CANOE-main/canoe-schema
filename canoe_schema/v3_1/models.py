...
class OutputObjective(CanoeBaseModel):
    ...
    total_system_cost: float | None = None
...
class OutputRetiredCapacity(CanoeBaseModel):
    ...
    tech: str = ...
    vintage: int = ...
    cap_eol: float | None = None
    cap_early: float | None = None
    units: str | None = None
...
class OutputCost(CanoeBaseModel):
    ...
    tech: str = ...
    vintage: int = ...
    d_invest: float | None = None
    d_fixed: float | None = None
    d_var: float | None = None
    d_emiss: float | None = None
    invest: float | None = None
    fixed: float | None = None
    var: float | None = None
    emiss: float | None = None
    units: str | None = None
